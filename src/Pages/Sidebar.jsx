            ...
            <div className="sidebar lg:fixed lg:left-0 lg:top-0 lg:h-screen lg:w-80 lg:bg-zinc-900 text-zinc-100 lg:p-6 max-lg:px-5 max-lg:py-6 lg:[box-shadow:0_-20px_80px_-40px_#ffffff3f_inset,0_0_20px_-5px_rgba(255,255,255,0.1)] ">
                <div className="sidebar-info">
                    <div className="info">
                        ...
                        <div className="status flex items-center lg:justify-center max-lg:my-3 lg:m-6">
                    ...
                    <div className="links lg:border-t border-zinc-700">
                        <div className="flex items-center justify-around max-lg:gap-3 lg:gap-6 mt-4">
                            <a className="text-zinc-400 lg:bg-zinc-800 lg:py-3 lg:px-5 lg:rounded-2xl" href="https://github.com/abdulrhman-mustafa" target='_blank'><FiGithub className="text-xl"/></a>
                            <a className="text-zinc-400 lg:bg-zinc-800 lg:py-3 lg:px-5 lg:rounded-2xl" href="https://www.linkedin.com/in/abdulrahman2910/" target='_blank'><FiLinkedin className="text-xl"/></a>
                            <a className="text-zinc-400 lg:bg-zinc-800 lg:py-3 lg:px-5 lg:rounded-2xl" href="https://wa.me/+201113572218" target='_blank'><RiWhatsappLine className="text-xl"/></a>
                        </div>
                    </div>
                </div>
                <Navbar></Navbar>
